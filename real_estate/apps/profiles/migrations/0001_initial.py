    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+91XXXXXXXXXX', max_length=30, region=None, verbose_name='Phone Number')),
                ('abount_me', models.TextField(default='say something about yourself', verbose_name='About me')),
                ...
                ('is_agent', models.BooleanField(default=False, help_text='Are you an angent?', verbose_name='Agent')),
