...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+91XXXXXXXXXX')
    abount_me = models.TextField(verbose_name=_('About me'), default='say something about yourself')
    ...
    is_agent = models.BooleanField(verbose_name=_('Agent'), default=False, help_text=_('Are you an angent?'))
